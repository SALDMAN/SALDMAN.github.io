...
<form action="https://formspree.io/f/yairsaldma@gmail.com" method="POST">
  ...
  <p>
    <label>Email / מייל:<br>
    <input type="email" name="_replyto" required style="width: 100%; max-width: 400px; padding: 5px; color: black;"></label>
  </p>
  <p>
    <label>Message / תוכן הפנייה:<br>
    <textarea name="message" rows="4" required style="width: 100%; max-width: 400px; padding: 5px; color: black;"></textarea></label>
  </p>
  <p>
    <button type="submit" style="background-color: #38bdf8; color: white; padding: 10px 20px; border: none; cursor: pointer;">Send / שלח</button>
  </p>
</form>
